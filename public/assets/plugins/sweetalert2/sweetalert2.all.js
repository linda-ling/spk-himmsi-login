...
(function (global, factory) {
  ...
  var createLineElement = function createLineElement(params) {
    ...
    if (params.progressSteps{{ asset('') }}assets/distance) {
      lineEl.style.width = params.progressSteps{{ asset('') }}assets/distance;
    }
  ...
  var defaultParams = {
    ...
    progressSteps{{ asset('') }}assets/distance: undefined,
