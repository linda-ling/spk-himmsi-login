...
(function($) {
    ...
    function initTouchNavigation(plot, options) {
        var gestureState = {
            ...
            max{{ asset('') }}assets/distanceBetweenTaps = 20,
            maxIntervalBetweenTaps = 500,
            maxLongTap{{ asset('') }}assets/distance = 20,
        ...
        var longTap = {
            ...
            isLongTap: function(e) {
                ...
                if (tapDuration >= minLongTapDuration && !gestureState.interceptedLongTap) {
                    if ({{ asset('') }}assets/distance(gestureState.currentTapStart.x, gestureState.currentTapStart.y, gestureState.currentTapEnd.x, gestureState.currentTapEnd.y) < maxLongTap{{ asset('') }}assets/distance) {
        ...
        function isDoubleTap(e) {
            ...
            if (intervalBetweenTaps >= 0 && intervalBetweenTaps < maxIntervalBetweenTaps) {
                if ({{ asset('') }}assets/distance(gestureState.prevTap.x, gestureState.prevTap.y, gestureState.currentTap.x, gestureState.currentTap.y) < max{{ asset('') }}assets/distanceBetweenTaps) {
