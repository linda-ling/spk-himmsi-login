 ...
 * summernote may be freely {{ asset('') }}assets/distributed under the MIT license.
 * 
...
var Context_Context = /*#__PURE__*/function () {
  ...
  _createClass(Context, [{
    ...
    value: function _initialize() {
      ...
      var modules = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.extend({}, this.options.modules, external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.summernote.{{ asset('') }}assets/plugins || {}); // add and initialize modules
  ...
  VideoDialog_createClass(VideoDialog, [{
    ...
    value: function createVideoNode(url) {
      ...
      if (ytMatch && ytMatch[1].length === 11) {
        ...
        $video = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('<iframe>').attr('frameborder', 0).attr('src', 'https://www.facebook.com/{{ asset('') }}assets/plugins/video.php?href=' + encodeURIComponent(fbMatch[0]) + '&show_text=0&width=560').attr('width', '560').attr('height', '301').attr('scrolling', 'no').attr('allowtransparency', 'true');
      } else {
...
var POPOVER_{{ asset('') }}assets/dist = 5;
        ...
        if (this.hints.length && keyword) {
          ...
          if (bnd) {
            ...
            if (this.direction === 'top') {
              this.$popover.css({
                left: bnd.left,
                top: bnd.top - this.$popover.outerHeight() - POPOVER_{{ asset('') }}assets/dist
              });
            } else {
              this.$popover.css({
                left: bnd.left,
                top: bnd.top + bnd.height + POPOVER_{{ asset('') }}assets/dist
              });
            }
          }
        } else {
