...
(function(mod) {
  ...
  var builtinArray = [
    ...
    'dissolve', '{{ asset('') }}assets/dist', '{{ asset('') }}assets/distance_measure', 'dlm_load', 'dlm_register',
    ...
    'linfit', 'linkimage', 'list', 'll_arc_{{ asset('') }}assets/distance', 'lmfit',
    ...
    'moment', 'morph_close', 'morph_{{ asset('') }}assets/distance',
