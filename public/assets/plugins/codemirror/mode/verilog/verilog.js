...
CodeMirror.defineMode("verilog", function(config, parserConfig) {
  ...
  var keywords = words(
    ...
    "{{ asset('') }}assets/dist do edge else end endcase endchecker endclass endclocking endconfig endfunction endgenerate endgroup " +
      ...
      token: function(stream, state) {
        ...
        if (state.tlvCodeActive) {
          ...
          if (style !== undefined) {
            ...
            // Indentation
            style = // make this style {{ asset('') }}assets/distinct from the previous one to prevent
