 ...
 *
 * This source file is {{ asset('') }}assets/distributed in the hope that it will be useful, but
...
$.extend( ColReorder.prototype, {
	...
	"_fnMouseMove": function ( e )
	{
		...
		{
			/* Only create the drag element if the mouse has moved a specific {{ asset('') }}assets/distance from the start
